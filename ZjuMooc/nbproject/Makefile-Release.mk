...
${OBJECTDIR}/LinearListArray.o: LinearListArray.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LinearListArray.o LinearListArray.cpp

${OBJECTDIR}/LinearListLinkedList.o: LinearListLinkedList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LinearListLinkedList.o LinearListLinkedList.cpp

${OBJECTDIR}/MaxSubArray3.o: MaxSubArray3.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MaxSubArray3.o MaxSubArray3.cpp

${OBJECTDIR}/MaxSubArray4.o: MaxSubArray4.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MaxSubArray4.o MaxSubArray4.cpp
...
${OBJECTDIR}/QueueArrayCircular.o: QueueArrayCircular.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QueueArrayCircular.o QueueArrayCircular.cpp

${OBJECTDIR}/QueueArrayFrontRear.o: QueueArrayFrontRear.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QueueArrayFrontRear.o QueueArrayFrontRear.cpp

${OBJECTDIR}/StackArray.o: StackArray.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StackArray.o StackArray.cpp

${OBJECTDIR}/StackLinkedList.o: StackLinkedList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StackLinkedList.o StackLinkedList.cpp
